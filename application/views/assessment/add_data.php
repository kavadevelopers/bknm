                                    ...
                                    <table class="table table-bordered table-sm" id="table">
                                        ...
                                        <tbody id="add_row">
                                            ...
                                            <tr id="tr1">
                                                ...
                                                <td style="width: 75px;">
                                                    <input style="width: 60px;" onfocus="cource_auto('1');" type="text" name="course[]" id="course1" autocomplete="off" placeholder="Course" required>
                                                    <input type="hidden" name="pap_rate[]" id="pap_rate1" value="0">
                                                </td>

                                                <td>
                                                    <input style="width: 30px;" type="text" onkeyup="total()" onkeydown="chng_to_next_row('1',event);" name="nos[]" id="nos1" autocomplete="off" placeholder="Nos" required>
                                                </td>
