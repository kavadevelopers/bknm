        	...
        	<div class="row mb-2">
                ...
                <div class="col-sm-6">
                    ...
                    <?php if(check_right('4')){ ?>
                        <a href="<?= base_url('modaration/view_all_bank'); ?>" style="margin-left: 5px;" class="float-sm-right btn btn-info btn-sm"> <i class="fa fa-eye"></i> View Files</a>
                    <?php } ?>

                    <?php if(check_right('3')){ ?>
                        <a id="export_al_corp"  href="<?= base_url('modaration/export_all_corp'); ?>" style="margin-left: 5px;" class="float-sm-right btn btn-warning btn-sm"> <i class="fa fa-eye"></i> Export Corporate</a>
                    <?php } ?>
                    
                    <?php if(check_right('2')){ ?>
                        <a id="export_bnk" href="<?= base_url('modaration/export_all_bank'); ?>" style="margin-left: 5px;" class="float-sm-right btn btn-warning btn-sm"> <i class="fa fa-eye"></i> Export Bank</a>
                    <?php } ?>

                    

                    <?php if(check_right('1')){ ?>
                        <a style="margin-left: 5px;" href="<?= base_url('modaration/add_file_view'); ?>" class="float-sm-right btn btn-primary btn-sm" > <i class="fa fa-plus"></i> Add New File</a>
                    <?php } ?>
                </div>
        	</div>
      	</div>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <?php if(check_right('5')){ ?>
                                                        <?php if($value['final'] != '1'){ ?>
                                                            <a class="badge badge-primary" href="<?= base_url();?>modaration/add_data/<?= urlencode($value['id']);?>" title="Add Data">
                                                                Add Bill
                                                            </a>
                                                    ...
                                                    <?php if(check_right('6')){ ?>
                                                        <a class="badge badge-info" href="<?= base_url();?>modaration/view_data/<?= $value['id'];?>" title="View File">
                                                            View File
                                                        </a>
                                                    <?php } ?>
                                                    ...
                                                    <?php if(check_right('7')){ ?>
                                                        ...
                                                        <a class="badge badge-warning" <?= $bank_link ?> href="<?= base_url();?>modaration/view_bills/<?= $value['id'];?>" title="View Bills">
                                                            View Bills
                                                        </a>
                                                    <?php } ?>
                                            ...
                                            <?php if(check_rights_column(['8','9'])){ ?>
                                                <td class="text-center">
                                                    <?php if(check_right('8')){ ?>
                                                        ...
                                                        <a class="badge badge-primary" <?= $bank_link ?> href="<?= base_url();?>modaration/print_bank/<?= urlencode($value['id']);?>" title="Print Bank Copy" target="_blank">
                                                            Print Bank Copy
                                                        </a>
                                                    <?php } ?>
                                                    ...
                                                    <?php if(check_right('9')){ ?>
                                                        ...
                                                        <a class="badge badge-info" <?= $corp_link ?> href="<?= base_url();?>modaration/print_corp_bank/<?= $value['id'];?>" title="View File" target="_blank">
                                            ...
                                            <?php if(check_rights_column(['10','11'])){ ?>
                                                <td class="text-center">
                                                    <?php if(check_right('10')){ ?>
                                                        <a class="badge badge-warning" href="<?= base_url();?>modaration/bank_download/<?= $value['id'];?>" title="Bank Copy Excel">
                                                            Bank Copy
                                                        </a>
                                                    <?php } ?>
                                                    <?php if(check_right('11')){ ?>
                                                        <a class="badge badge-secondary" href="<?= base_url();?>modaration/corp_download/<?= $value['id'];?>" title="Corporate Copy Excel">
                                                            Corporate Copy
                                                        </a>
                                                    <?php } ?>
                                                </td>
        ...
        $(function(){
            $('#export_bnk').click(function(){
                ...
                if(checkedIds == ''){
                    ...
                    window.location = '<?= base_url() ?>modaration/export_all_bank?ids='+checkedIds;    
                }
            ...
            $('#export_al_corp').click(function(){
                ...
                if(checkedIds == ''){
                    ...
                    window.location = '<?= base_url() ?>modaration/export_all_corp?ids='+checkedIds;    
                }
