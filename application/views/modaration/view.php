                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-info"  style="overflow-x: scroll;"> 
                            ...
                            <div class="card-body">
                                <a href="<?= base_url('modaration/view_data_print/').$file['id'] ?>" target="_blank" class="btn btn-sm btn-secondary pull-right" style="color: #fff;">Print</a>
                                <div class="row">
                                                ...
                                                <td>
                                                    <?php if(check_right('5')){ ?>
                                                        <?php if($file['final'] != '1'){ ?>
                                                            ...
                                                            <a class="btn btn-sm btn-primary" href="<?= base_url();?>modaration/add_data/<?= $file['id'] ?>" title="Edit">
