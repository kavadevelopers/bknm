...
<!-- Main content -->
    <section class="content">
      	<div class="container-fluid">
            <form method="post" action="<?= base_url();?>key_persons/save" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('percentage','0.00'); ?>" type="text" name="percentage" id="percentage" placeholder="Commission Percentage%ex.(1.50)"  autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('fi_name'); ?>" type="text" name="fi_name" id="fi_name" placeholder="First Name"  autocomplete="off">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('mi_name'); ?>" type="text" name="mi_name" id="mi_name" placeholder="Middle Name"  autocomplete="off">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('la_name'); ?>" type="text" name="la_name" id="la_name" placeholder="Last Name"  autocomplete="off">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('fa_name'); ?>" type="text" name="fa_name" id="fa_name" placeholder="Father name"  autocomplete="off">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('mo_name'); ?>" type="text" name="mo_name" id="mo_name" placeholder="Mother name"  autocomplete="off">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm date_picker" value="<?php echo set_value('bdate'); ?>" autocomplete="off" type="text" name=" bdate" id=" bdate" placeholder="Date Of Birth" readonly>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('jdate',date('d-m-Y')); ?>" autocomplete="off" type="text" name="jdate" id="jdate" placeholder=" Date Of Joining" readonly>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Age</label>
                                            <input class="form-control form-control-sm" value="<?php echo set_value('age'); ?>" type="text" name="age" id="age" placeholder="Age" readonly>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('quali'); ?>" type="text" name="quali" id="quali" placeholder="Qualification" >
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('desig'); ?>" type="text" name="desig" id="desig" placeholder="Designation" >
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm" value="<?php echo set_value('mobile'); ?>" type="text" name="mobile" id="mobile" placeholder="Mobile Number" autocomplete="off">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm" value="<?php echo set_value('mobile2'); ?>" type="text" name="mobile2" autocomplete="off" id="mobile2" placeholder="Mobile Number2" >
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-sm" value="<?php echo set_value('bank'); ?>" type="text" name="bank" id="bank" placeholder="Bank Name" >
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-sm" value="<?php echo set_value('ac_number'); ?>" type="text" name="ac_number" id="ac_number" placeholder="A/C Number" autocomplete="off">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-sm" value="<?php echo set_value('ifsc_code'); ?>" type="text" name="ifsc_code" id="ifsc_code" placeholder=" IFSC Code" autocomplete="off">
                               ...
                               <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-sm" value="<?php echo set_value('branch_name'); ?>" type="text" name="branch_name" id="branch_name" placeholder="Branch Name" >
