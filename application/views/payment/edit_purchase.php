...
<!-- Main content -->
    <section class="content">
      	<div class="container-fluid">
            <form method="post" action="<?= base_url();?>payment/purchase_update" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                    	...
                    	<div class="card card-info"> 
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <?php 
                                        $_bal_amount = $purchase_edit['deal_amount'] - $purchase_edit['adva_payment'];
                                        $_rem_amount = ($purchase_edit['remaining_amount'] + $purchase_edit['instal_amount']);
                                        $_paid_amount = $_bal_amount - $_rem_amount;
                                    ?>
                                	<div class="col-md-3">
                                        <div class="form-group">
                                            <label>Selling Amount</label>
                                            <input class="form-control form-control-sm" type="text" name="" placeholder="Selling Amount" value="<?php echo $purchase_edit['deal_amount']; ?>" autocomplete="off" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" type="text" name="" placeholder="Advance Payment" value="<?php echo $purchase_edit['adva_payment']; ?>" autocomplete="off" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" type="text" name="" placeholder="Installment No." value="<?php echo $purchase_edit['no_of_installment']; ?>" autocomplete="off" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" type="text" name="amount_install" placeholder="Installment Amount" value="<?php echo $purchase_edit['instal_amount']; ?>" autocomplete="off" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" type="text" name="" placeholder="Due Date" value="<?php echo _vdate($purchase_edit['date']); ?>" autocomplete="off" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Time</label>
                                            <input class="form-control form-control-sm" type="text" name="" placeholder="Time" value="<?php echo $purchase_edit['time']; ?>" autocomplete="off" readonly>
                                        </div>
                                    </div>
