                        ...
                        <div class="card card-info"> 
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Leg <span class="astrick">*</span></label>
                                            <select class="form-control form-control-sm" name="leg" >
                                                <option value="">-- Select Leg --</option>
                                                <option value="left" <?php if(set_value('leg') == 'left') { echo "selected"; } ?>>Left</option>
                                                <option value="right" <?php if(set_value('leg') == 'right') { echo "selected"; } ?>>Right</option>
                                            </select> 
                                            <?php echo form_error('leg'); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm date_picker" value="<?php echo set_value('bdate'); ?>" autocomplete="off" type="text" name="bdate" placeholder="Birth Date" readonly>
