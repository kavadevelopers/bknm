                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" id="title" value="<?php echo set_value('title'); ?>" type="text" name="title" placeholder="File Title" autocomplete="off" spellcheck="false" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" id="message" value="<?php echo set_value('message'); ?>" type="text" name="message" placeholder="Message" autocomplete="off" spellcheck="false" required>
