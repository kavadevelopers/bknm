                                    ...
                                    <table class="table table-bordered table-sm" id="table">
                                        ...
                                        <?php $cn = 0; foreach($old_data as $row => $ex_row){ $cn++; ?>    
                                            <tr id="tr<?= $cn; ?>">
                                                ...
                                                <td>
                                                    <input style="width: 80px;" type="text" name="rcbook[]" id="rcbook<?= $cn; ?>" autocomplete="off" placeholder="Rc Book No." value="<?= $ex_row['rcbook']; ?>">
                                                </td>
                                                ...
                                                <td>
                                                    <input style="width: 50px;" type="number" onkeyup="total()" name="session[]" id="session<?= $cn; ?>" autocomplete="off" placeholder="Session" value="<?= $ex_row['session']; ?>">
                                                </td>
                                                ...
                                                <td>
                                                    <input type="text" name="session_total_amount[]" value="<?= $ex_row['session_total']; ?>" id="session_total_amount<?= $cn; ?>" autocomplete="off" placeholder="Session Total" readonly>
                                                </td>
