...
<!-- Main content -->
    <section class="content">
        <div class="container-fluid">
            <form method="post" action="<?= base_url('profile/update_customer');?>" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Date of Birth <span class="astrick">*</span></label>
                                            <input class="form-control form-control-sm date_picker" type="text" id="no_bdate" name="no_bdate" value="<?php echo set_value('no_bdate',date('d-m-Y',strtotime($customer['no_bdate']))); ?>" placeholder="Date of Birth" autocomplete="off">
