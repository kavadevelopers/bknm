    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <a href="profile/customer" class="float-sm-right btn btn-primary btn-sm"> <i class="fa fa-edit"></i> Edit Profile</a>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                        ...
                        <div class="card-title mb-4">
                            <div class="d-flex justify-content-start">
                                ...
                                <div class="userData ml-3">
                                    ...
                                    <h5 class="d-block"><?=$user['user_type']?></h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="connectedServices-tab" data-toggle="tab" href="#bankdetails" role="tab" aria-controls="connectedServices" aria-selected="false">Nominee’s Details</a>
                                    </li>
                                </ul>
