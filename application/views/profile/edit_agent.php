...
<!-- Main content -->
    <section class="content">
      	<div class="container-fluid">
            <form method="post" action="<?= base_url('profile/agent_update'); ?>" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-info"> 
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Reference Id <span class="astrick">*</span></label>
                                            <input class="form-control form-control-sm" value="<?php echo set_value('ref',$user['user_type_id']); ?>" type="text" name="ref" placeholder="Reference Id" autocomplete="off" readonly>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="image-container">
                                                    <img src="<?=base_url();?>uploads/<?=$user['image']?>" id="imgProfile" style="width: 150px; height: 150px;" class="img-thumbnail kava-image-upload" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('fa_name',$agent['fa_name']); ?>" type="text" name="fa_name" placeholder="Father Name" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('bank',$agent['bank']); ?>" type="text" name="bank" placeholder="Bank Name" readonly>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('ac_number',$agent['ac_number']); ?>" type="text" name="ac_number" placeholder="A/C Number" autocomplete="off" readonly>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('ifsc_code',$agent['ifsc_code']); ?>" type="text" name="ifsc_code" placeholder="IFSC Code" autocomplete="off"readonly>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('branch_name',$agent['branch_name']); ?>" type="text" name="branch_name" placeholder="Branch Name" readonly>
