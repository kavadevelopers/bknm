...
<!-- Main content -->
    <section class="content">
      	<div class="container-fluid">
            <form method="post" action="<?= base_url();?>profile/business_update" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-sm" value="<?php echo set_value('bank',$business['bank']); ?>" type="text" name="bank" id="bank" placeholder="Bank Name" readonly>
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-sm" value="<?php echo set_value('ac_number',$business['ac_number']); ?>" type="text" name="ac_number" id="ac_number" placeholder="A/C Number" autocomplete="off" readonly>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-sm" value="<?php echo set_value('ifsc_code',$business['ifsc_code']); ?>" type="text" name="ifsc_code" id="ifsc_code" placeholder=" IFSC Code" autocomplete="off" readonly>
                               ...
                               <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-sm" value="<?php echo set_value('branch_name',$business['branch_name']); ?>" type="text" name="branch_name" id="branch_name" placeholder="Branch Name" readonly>
