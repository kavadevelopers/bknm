                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="<?php echo set_value('subject_name'); ?>" type="text" name="subject_name" placeholder="Subject Name" autocomplete="off" spellcheck="false">
