    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <a href="<?= base_url('booking/add'); ?>" class="float-sm-right btn btn-primary btn-sm"> <i class="fa fa-plus"></i> Add New</a>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-secondary btn-sm" 
                                                    href="<?= base_url('booking/print_invoice/'); ?><?= $key['id']; ?>"  target="_blank"><i class="fa fa-print" title="Print"></i>
                                                </a>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-info btn-sm" 
                                                    href="<?= base_url('booking/view/'); ?><?= $key['id']; ?>">
                                                    <i class="fa fa-eye" title="View"></i></a>
                                                
                                                <a class="btn btn-secondary btn-sm" 
                                                    href="<?= base_url('booking/sale_print/'); ?><?= $key['id']; ?>"  target="_blank">
                                                    <i class="fa fa-print" title="Print"></i></a>

                                                <?php if($this->session->userdata('id') == '1'){ ?>

                                                    <a class="btn btn-warning btn-sm" 
                                                    href="<?= base_url('booking/sale_report/'); ?><?= $key['id']; ?>" >
                                                    <i class="fa fa-line-chart" title="Print"></i></a>

                                                    <a style="background: #ff3b3b;" class="btn btn-warning btn-sm" 
                                                    href="" onclick="return master('<?= base_url();?>booking/cancel/<?= $key['id'];?>');" >
                                                    <i class="fa fa-ban" title="cancel plan / booking"></i></a>

                                                    <a class="btn btn-sm btn-danger" onclick="return master('<?= base_url();?>booking/delete/<?= $key['id'];?>');" href="" title="Delete">
