...
<!-- Main content -->
    <section class="content">
        <div class="container-fluid">
            <form method="post" id="selling_form" action="<?= base_url();?>booking/save" enctype="product/form-data">
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm select2" name="coust_name" autocomplete="off" required>
