...
<!-- Main content -->
    <section class="content">
      	<div class="container-fluid">
            <form method="post" action="<?= base_url();?>report/show_admin_report" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label>Select Admin<span class="astrick">*</span></label>
                                            <select class="form-control form-control-sm select2" name="admin" autocomplete="off" required>
                                            	<option value="">-- Select Admin --</option>

                                            	<?php foreach ($admins as $key => $value) { ?>
                                            		<option value="<?= $value['id']; ?>" ><?= $value['user_type_id']; ?></option>
                                            	<?php } ?>
