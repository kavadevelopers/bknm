                                    ...
                                    <table class="table table-bordered table-sm" id="table">
                                        ...
                                        <tbody id="add_row">
                                            ...
                                            <tr id="tr1">
                                                ...
                                                <td>
                                                    <input style="width: 75px;" onfocus="cource_auto('1');" type="text" name="course[]" id="course1" autocomplete="off" placeholder="Course" required>
                                                    <input type="hidden" name="pap_rate[]" id="pap_rate1" value="0">
                                                </td>

                                                <td>
                                                    <input style="width: 50px;" type="number" onkeyup="total()" name="nos[]" id="nos1" autocomplete="off" placeholder="Nos" required>
                                                </td>

                                                

                                                <td>
                                                    <input style="width: 50px;" type="text" onkeyup="total()" name="day[]" id="day1" autocomplete="off" placeholder="Day">
                                                </td>
                                                ...
                                                <td>
                                                    <input type="text" name="papertotal[]" id="papertotal1" autocomplete="off" placeholder="Paper Setting Total" readonly>
                                                </td>


                                                <td>
                                                    <input type="text" name="day_tot[]" id="day_tot1" autocomplete="off" placeholder="Day Allowance" readonly>
                                                </td>
