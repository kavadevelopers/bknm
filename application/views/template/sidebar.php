    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="<?php echo base_url(); ?><?=$this->config->config["logoFile"]?>" style="width: 40px; height:40px;" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview <?php menu($this->uri->segment(1),array("paper_setting","squad","assessment","modaration"))[1]; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url('assessment'); ?>" class="nav-link <?php menu($this->uri->segment(1),array("assessment"))[0]; ?>">
                                    <i class="nav-icon fa fa-circle-o"></i>
                                    <p>
                                        Assessment
                                    </p>
