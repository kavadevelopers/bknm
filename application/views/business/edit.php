...
<!-- Main content -->
    <section class="content">
      	<div class="container-fluid">
            <form method="post" action="<?= base_url();?>business/update" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" value="0.00" type="hidden" name="percentage" id="percentage" placeholder="Commission Percentage%ex.(1.50)"  autocomplete="off">
